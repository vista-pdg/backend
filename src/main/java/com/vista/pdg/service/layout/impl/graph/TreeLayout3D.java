...
public class TreeLayout3D implements LayoutStrategy {
    ...
    private int computeWidth(String id, Map<String, List<String>> children, Map<String, Integer> width) {
        List<String> ch = children.getOrDefault(id, List.of());
        if (ch.isEmpty()) { width.put(id, 1); return 1; }
        int total = 0;
    ...
    private void placeNode(String id, int depth, double angleStart, double angleEnd,
